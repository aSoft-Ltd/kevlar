...
subprojects {
    ...
    configure<MavenPublishBaseExtension> {
        ...
        pom {
            ...
            url.set("https://github.com/aSoft-Ltd/kevlar")
            licenses {
                license {
                    name.set("MIT License")
                    url.set("https://github.com/aSoft-Ltd/kevlar/blob/master/LICENSE")
                }
            }
            developers {
                developer {
            ...
            scm {
                url.set("https://github.com/aSoft-Ltd/kevlar/")
                connection.set("scm:git:git://github.com/aSoft-Ltd/kevlar.git")
                developerConnection.set("scm:git:ssh://git@github.com/aSoft-Ltd/kevlar.git")
            }
        }
    }
}
